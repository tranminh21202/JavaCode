...
class SXDonHang{
    ...
    public SXDonHang(String ten, String ma, long dongia, long sl) {
        this.ten = ten;
        this.ma = ma;
        this.dongia = dongia;
        this.sl = sl;
...
public class SapXepDonHang {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<SXDonHang> list = new ArrayList<>();
        ...
        for(int i=1;i<=t;i++){
            ...
            SXDonHang a = new SXDonHang(ten,ma,dongia,sl);
            list.add(a);
        }
        Collections.sort(list, Comparator.comparing(SXDonHang::getSTT));
        for(SXDonHang x:list){
