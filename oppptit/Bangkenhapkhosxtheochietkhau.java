...
class NhapKhoSX{
    ...
    public NhapKhoSX(int n, String ma, String ten, int sl, int dongia) {
...
public class Bangkenhapkhosxtheochietkhau {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<NhapKhoSX> list = new ArrayList<>();
        ...
        while(t-->0){
            ...
            i = map.get(ma);
            NhapKhoSX a = new NhapKhoSX(i,ma,ten,sl,dongia);
            list.add(a);
        }
        Collections.sort(list, Comparator.comparingInt(NhapKhoSX::getChiet).reversed());
        for(NhapKhoSX x:list){
